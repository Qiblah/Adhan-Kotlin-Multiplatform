...
object CalendarUtil {
    ...
    fun roundedMinute(whenInstant: Instant): Instant {
        ...
        return LocalDateTime(year = dateTime.year, monthNumber = dateTime.monthNumber,
    ...
    // Overload for resolveTime with DateComponents if needed
    // Assuming DateComponents is a data class with year, month, and day properties.
    fun resolveTime(components: DateComponents): Instant {
        return resolveTime(components.year, components.month, components.day)
    }

    // DateComponents class definition placeholder
